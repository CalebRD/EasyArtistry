    ...
    def ui(self, is_img2img):
        ...
        with gr.Group(visible=False, elem_id=self.elem_id("seed_extras")) as seed_extras:
            ...
            with gr.Row(elem_id=self.elem_id("seed_resize_from_row")):
                seed_resize_from_w = gr.Slider(minimum=0, maximum=1920, step=8, label="Resize seed from width", value=0, elem_id=self.elem_id("seed_resize_from_w"))
                seed_resize_from_h = gr.Slider(minimum=0, maximum=1080, step=8, label="Resize seed from height", value=0, elem_id=self.elem_id("seed_resize_from_h"))
